...
namespace hypeJunction\Filestore\Tests;

use PHPUnit\Framework\TestCase;

/**
 * Auto-generated migration regression guard for plugin "hypefilestore".
 *
 ...
 * the target major (Elgg 7.x). Run it BEFORE touching any plugin code:
 *
...
final class MigrationRegressionTest extends TestCase
{
    ...
    private const REMOVED_FUNCTIONS = [
        ...
        4 => [
            ...
            // Setter half of the removed save/restore visibility pattern — gone
            // in 4.x alongside access_get_show_hidden_status() (see catalog note
            // on removed-functions.json). hypeFilestore's Factory::outputRawIcon
            // still calls it, so this guard flags that residue on 7.x.
