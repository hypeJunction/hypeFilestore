...
namespace hypeJunction\Filestore\Handlers\Uploader;
...
class Upload {
	 ...
	 * @param string $prefix     Filestore prefix
	 * @return Upload
	 */
	public function save(array $attributes = [], $prefix = self::DEFAULT_FILESTORE_PREFIX) {
	...
	public function getError() {
		switch ($this->error_code) {
			...
			case UPLOAD_ERR_NO_FILE:
				...
				// no break — pre-existing fall-through; tracked in elgg-migrate-kjw5 follow-up.
